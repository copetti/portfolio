...
const navigation = [
        {
            name: 'Facebook',
            href: 'https://www.facebook.com/andrebarros152',
        ...
        {
            name: 'Instagram',
            href: 'https://instagram.com/andreecopetti',
            icon: defineComponent({
                render: () =>
                    h('svg', {fill: 'currentColor', viewBox: '0 0 24 24'}, [
                        h('path', {
        ...
        {
            name: 'Linkedin',
            href: 'https://www.linkedin.com/in/andré-copetti',
            icon: defineComponent({
                render: () =>
